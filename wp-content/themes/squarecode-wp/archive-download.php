    ...
    <div class="search_EDD">
        ...
        <div class="clear"></div>
            ...
            <div class="orderby">
                ...
                <div>
                    <a class="uparrow" href="<?php echo $by_price;?>"><span class="orderme"><?php _e( 'Price', 'squarecode' ); ?></span><span class="dashicons dashicons-arrow-up-alt2"></span></a>
                    <a class="downarrow" href="<?php echo $by_pricedesc;?>"><span class="orderme"><?php _e( 'Price', 'squarecode' ); ?></span><span class="dashicons dashicons-arrow-down-alt2"></span></a>
                </div>
                <div>
                    <a class="uparrow" href="<?php echo $by_title;?>"><span class="orderme"><?php _e( 'Title', 'squarecode' ); ?></span><span class="dashicons dashicons-arrow-up-alt2"></span></a>
                    <a class="downarrow" href="<?php echo $by_titledesc;?>"><span class="orderme"><?php _e( 'Title', 'squarecode' ); ?></span><span class="dashicons dashicons-arrow-down-alt2"></span></a>
                </div>
                <div>
                    <a class="uparrow" href="<?php echo $by_date;?>"><span class="orderme"><?php _e( 'Date', 'squarecode' ); ?></span><span class="dashicons dashicons-arrow-up-alt2"></span></a>
                    <a class="downarrow" href="<?php echo $by_datedesc;?>"><span class="orderme"><?php _e( 'Date', 'squarecode' ); ?></span><span class="dashicons dashicons-arrow-down-alt2"></span></a>
                </div>
        ...
        <li class="cr3ativeportfolio_portfolio-itemthree min-height">
            ...
            <div class="edd_feat_image_index">
                ...
                <div class="caption" onclick="">
                    ...
                    </div><!-- End of thumb author details -->
