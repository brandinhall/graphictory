       <section id="slider" class="slider-parallax full-screen force-full-screen swiper_wrapper clearfix" style="padding:30px; margin-top:-30px;">
                    ...
                    <div class="swiper-slide" style="background-image: url('<?php $background_image = get_field('background_image'); if( !empty($background_image) ): ?><?php echo $background_image; ?><?php endif; ?>');">
                        ...
                        <div class="container clearfix">
                            <div class="slider-caption <?php $slider_class = get_field('slider_class'); if( !empty($slider_class) ): ?><?php echo $slider_class; ?><?php endif; ?>">
                                ...
                                <h2 class="home-title" data-caption-animate="fadeInUp">


                                <?php $slider_title = get_field('slider_title'); if( !empty($slider_title) ): ?><?php echo $slider_title; ?><?php endif; ?></h2>
                                <div class="dark" style="z-index:20"><?php the_content();?></div>
                                ...
                                <a href="<?php $button_2_link = get_field('button_2_link'); if( !empty($button_2_link) ): ?><?php echo $button_2_link; ?><?php endif; ?>" class="button button-rounded button-light" data-animate="fadeInUp" data-delay="300"><?php echo $button_2_text; ?></a>
