...
class ACFFrontendForm {
	...
	public function adminNotices( ) {
		...
		if ( !acffef_dependency_active('cpt-ui') || !acffef_dependency_active('acf') ) {
			?>
			<div class="updated">
				<p>Front End Form Extension for ACF requires that you install and activate all of these plugins:
				<?php if ( !acffef_dependency_active('cpt-ui') ) echo '<a class="thickbox" href="'.admin_url('plugin-install.php?tab=plugin-information&plugin=custom-post-type-ui&TB_iframe=true&width=600&height=550').'">Custom Post Type UI Plugin</a>'; ?>
				<?php if ( !acffef_dependency_active('acf') ) echo ", <a href='http://www.advancedcustomfields.com/'>Advanced Custom Fields</a>"; ?>
				</p>
	...
	$im_plugins_list = array(
		...
		'Premium Bulk Photo To Product Importer Extension For WooCommerce' => 'https://www.iteratemarketing.com/product/premium-bulk-photo-to-product-importer-extension-for-woocommerce',
	...
	?>
			<th class="title"><h3><?php _e( 'Info', 'ptp' ); ?></h3></th>
			<td>
			<table class="ptp-input widefat">
				<tbody>
					<tr>
						<td>
							This Plugin was created by <a href="https://www.iteratemarketing.com/">Iterate Marketing</a> and <a href="https://www.iteratemarketing.com/services/wordpress-plugins">you can find more of our Plugins, or request a custom one, here </a>.
							<?php
